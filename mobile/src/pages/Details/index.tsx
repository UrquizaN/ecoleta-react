...
const Details = () => {
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho itens para coleta`);
  }
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        <RectButton style={styles.button} >
          <FontAwesome name="whatsapp"  size={24} color="#FFF" onPress={handleWhatsapp} />
